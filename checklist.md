...
| [ ] | F-06 | Commit and push `codex/backend-implementation`, then open a PR to `main` with summary, validation evidence, risks, and scope boundaries. | Planned | GitHub PR URL recorded here. |
