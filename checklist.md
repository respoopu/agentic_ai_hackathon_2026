...
| [x] | UI-03 | Build the plan→check→book→learn journey. | Reconciled | The responsive interface shows real sourced activity details, an explicit trusted-adult handoff, exact-plan approval requirements, a prominent sandbox receipt, teen preparation, adult reassurance, attendance and a text debrief. |
