...
|---|---|---|---|---|---|
| **OW-02** | P0 | **Done** | Ask organisers about submission logistics and live Q&A | Rayden | Rayden confirmed on 2 Sep that the organiser response has been received; submission logistics are no longer an open research dependency. The team follows the authoritative organiser instructions held with the registration materials. |
